...
export function addPost(data) { return request({ url: '/system/post', method: 'post', data }) }
export function updatePost(data) { return request({ url: '/system/post', method: 'put', data }) }
